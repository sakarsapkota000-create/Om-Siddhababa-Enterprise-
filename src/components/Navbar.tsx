        ...
        >
          ...
          <div className="space-y-0.5 select-none">
            <h1 className="text-sm sm:text-base md:text-[18px] font-black text-gray-950 tracking-tight leading-none uppercase flex items-center gap-2">
              <span className="inline-flex items-center justify-center bg-gradient-to-br from-brand-green to-slate-900 text-brand-gold p-1.5 rounded-xl shadow-sm border border-brand-gold/30 shrink-0">
                <svg className="w-4 h-4 text-brand-gold animate-spin" style={{ animationDuration: '6s' }} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5">
